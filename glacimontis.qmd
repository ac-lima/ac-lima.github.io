...
---
title: "GLACIMONTIS"
subtitle: "Mountain glacier extents at the Last Glacial Maximum"
page-layout: full
toc: false
format:
  html:
...
GLACIMONTIS includes two main spatial products:

::: {.feature-list}

::: {.feature-item}
### Empirically Reconstructed Paleoglaciers
A compilation of the individual glacier reconstructions, organised by source and mountain range. This layer preserves the original reconstruction context as much as possible.
:::
